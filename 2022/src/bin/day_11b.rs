...
fn solve(input: &str) -> usize {
    ...
    let mut monkeys: Vec<Monkey> = input
        ...
        .map(|raw_monkey| {
            ...
            let test: u64 = next_stripped("Test: divisible by ").parse().unwrap();
            max_worry *= test;
...
impl Monkey {
    ...
    fn receive(&mut self, worry: u64) {
        self.worries.push(worry)
    }
}
